...
const MONGO_URI = process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/jengabet';
...
app.post('/api/deposit', async (req, res) => {
    try {
        ...
        const payload = {
            ...
            callback_url: `${process.env.APP_URL || 'https://api.jengabet.com'}/api/megapay/webhook`,
            description:  'JengaBet Deposit',
            reference:    reference
        };
